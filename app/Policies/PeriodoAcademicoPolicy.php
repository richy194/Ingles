...
class PeriodoAcademicoPolicy
{
    ...
    {
        return $user->can('delete_any_periodo::academico');
    }
    ...
    {
        return $user->can('force_delete_any_periodo::academico');
    }
    ...
    {
        return $user->can('restore_any_periodo::academico');
    }
    ...
    {
        return $user->can('replicate_periodo::academico');
    }
    ...
    {
        return $user->can('reorder_periodo::academico');
    }
}
