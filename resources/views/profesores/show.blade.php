    ...
    <div class="page-shell">
        <section class="hero">
            <div>
                ...
                <p>Información completa del perfil y datos del profesor.</p>
            </div>
            <div class="actions">
                <a href="{{ route('profesores.index') }}" class="btn btn-neutral">Volver</a>
                @can('update', $profesor)
                ...
                @can('delete', $profesor)
                    <form action="{{ route('profesores.destroy', $profesor->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger" onclick="return confirm('¿Eliminar este profesor?')">Eliminar</button>
                    </form>
                @endcan
            </div>
        </section>
            ...
            <div class="card-body">
                ...
                <div class="details-grid">
                    <div class="detail-item">
                        ...
                        <div class="value">{{ $profesor->nombre ?? 'No asignado' }}</div>
                    </div>
                    <div class="detail-item">
                        <label>Email</label>
                        <div class="value">{{ $profesor->email ?? 'No asignado' }}</div>
                    </div>
                    <div class="detail-item">
                        <label>Documento</label>
                        <div class="value">{{ $profesor->documento ?? 'No asignado' }}</div>
                    </div>
                    <div class="detail-item">
                        <label>Teléfono</label>
                        <div class="value">{{ $profesor->telefono ?? 'No asignado' }}</div>
                    </div>
                    <div class="detail-item">
                        <label>Dirección</label>
                        <div class="value">{{ $profesor->direccion ?? 'No asignado' }}</div>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <a href="{{ route('profesores.index') }}" class="btn btn-neutral">Volver al Listado</a>
                    @can('update', $profesor)
                        <a href="{{ route('profesores.edit', $profesor->id) }}" class="btn btn-warning">Editar Profesor</a>
                    @endcan
                </div>
            </div>
        </section>
